...
/**Models a swimming activity during the early hours of the day
 *
 * @author Sonke Tietgens <K1186281>
 */
public class EarlySwimmer extends PolicyComponent {
   
    /**creates a new EarlySwimmer object
     * 
     * @param h the household which uses policyComponent
     */
    public EarlySwimmer(HouseHold h) {
        super(h);
    }
    ...
    public Stack<TimedEvent> generalRules() {
        ...
        for (Appliance heat : heaters) {
            stack.push(heat.generateUsageHour(8, 4, new Time(0, 2, 0, 0, 0)));
